...
const jugarPiedraPapelTijeras = (jugadoraA, jugadoraB, jugadasA, jugadasB) =>{
        ...
        for(let i=0; i<jugadasA.length; i++){
            ...
            if(jugadasA[i]==='tijera'&& jugadasB[i]==='piedra' || jugadasA[i]==='piedra'&& jugadasB[i]==='papel' || jugadasA[i]==='papel' && jugadasB[i]==='tijera'){
            puntajeFinalB++;
            
        } else if(jugadasA[i]==='piedra'&& jugadasB[i]==='tijera' || jugadasA[i]==='papel'&& jugadasB[i]==='piedra' || jugadasA[i]==='tijera' && jugadasB[i]==='papel'){
            puntajeFinalA++;
        } else{
        ...
        if(puntajeFinalA>puntajeFinalB){
            alert(`Ganó ${jugadoraA}`)
        } else if (puntajeFinalA<puntajeFinalB){
            alert(`Ganó ${jugadoraB}`)
        } else if(puntajeFinalA===puntajeFinalB){
            alert('Empate')
        }
    console.log(puntajeFinalA)
    console.log(puntajeFinalB)
    }

//jugarPiedraPapelTijeras('Ada', 'Grace', ['tijera'], ['piedra']) 
//jugarPiedraPapelTijeras('Ada', 'Grace', ['papel'], ['papel']) 
//jugarPiedraPapelTijeras('Ada','Grace', ['piedra', 'papel', 'papel', 'piedra', 'tijera'], ['papel', 'piedra', 'tijera', 'tijera', 'papel'])
